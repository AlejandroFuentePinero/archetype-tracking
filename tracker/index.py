...
# The index lives beside the store: it is a fact about the cache that store was
# built from, and a run reading one is reading the other. It is committed, which
